...
% Analysis parameters
    ...
    MRS_struct.p.data_phase_correction = 1; % 1 = YES; perform eddy current correction on metabolite data
    MRS_struct.p.water_removal = 1; % 1 = YES; remove residual water signal using HSVD
    MRS_struct.p.AlignTo = 'SpecReg'; % options are 'RobustSpecReg' (recommended), 'SpecReg', 'SpecRegHERMES',
    ...
    MRS_struct.p.FitResidWater = 1; % 1 = YES, fit the residual water signal in the DIFF spectrum to calculate water suppression factor
